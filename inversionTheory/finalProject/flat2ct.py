...
sp1 = Sampling(251,0.004,0.50)
sp2 = Sampling(357,0.025,0.00)
dx,dt = 0.025,0.004
fx,ft = 0.000,0.500
...
def main(args):
  ...
  #horizonExtract()
def flatten():
  k1s = [[ 44, 40],[180,182],[160,157]]
  k2s = [[210,260],[128,159],[120,180]]
...
def plot(s1,s2,x,u=None,c=None,cmap=ColorMap.GRAY,clab=None,vlabel=None,hlabel=None,
  ...
  if c:
    ...
    nc = len(k1s)
    tp1 = PointsView.Mark.PLUS
    tp2 = PointsView.Mark.HOLLOW_CIRCLE
    tp3 = PointsView.Mark.HOLLOW_SQUARE
    tps = [tp1,tp2,tp3]
    for ic in range(nc):
      np = len(k1s[ic])
      k1p = zerofloat(np)
